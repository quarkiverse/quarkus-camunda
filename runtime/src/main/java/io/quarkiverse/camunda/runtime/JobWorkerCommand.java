...
public class JobWorkerCommand {
    ...
    public void send() {
        ...
        command.send().handle((o, ex) -> {
            if (ex != null) {
                ...
                tracingContext.error(Tracing.JOB_CMD_EXCEPTION, ex);
                ...
                try {
                    ...
                    tracingContext.error(Tracing.JOB_ERROR_HANDLER_EXCEPTION, t);
    ...
    public static JobWorkerCommand createThrowErrorCommand(JobClient client, ActivatedJob job, BpmnError bpmnError) {
