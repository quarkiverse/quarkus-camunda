...
public interface ClientRuntimeConfig {
    ...
    /**
     * Camunda client cloud configuration.
     */
    @WithName("cloud")
    CloudConfig cloud();

    /**
     * Camunda client OAuth configuration.
     */
    @WithName("oauth")
    OAuthConfig oauth();
    ...
    /**
     * Camunda client worker type optional configuration.
     */
    @WithName("workers")
    ...
    /**
     * Camunda client message configuration.
     */
    @WithName("message")
    ...
    /**
     * Camunda client job configuration.
     */
    @WithName("job")
    JobConfig job();

    /**
     * Camunda client tracing configuration.
     */
    @WithName("tracing")
    TracingConfig tracing();

    /**
     * Camunda client tenant configuration.
     */
    @WithName("tenant")
    TenantConfig tenant();
    ...
    interface TenantConfig {
        ...
        /**
         * Camunda client default job worker tenant ID's.
