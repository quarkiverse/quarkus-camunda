...
public class Recorder {
    ...
    public Recorder(RuntimeValue<RuntimeConfig> runtimeConfig) {
    ...
    private static String getJobType(ClientRuntimeConfig config, JobWorkerMetadata meta) {
    ...
    private static JobWorker buildJobWorker(CamundaClient client,
        ...
        ClientRuntimeConfig.JobHandlerConfig jonHandlerConfig = config.workers().get(type);
