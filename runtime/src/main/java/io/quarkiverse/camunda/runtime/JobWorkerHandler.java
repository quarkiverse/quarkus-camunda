...
import io.quarkiverse.camunda.runtime.tracing.TracingRecorder;
...
public class JobWorkerHandler implements JobHandler {
    ...
    private ClientRuntimeConfig.AutoCompleteConfig autoCompleteConfig;
    ...
    public JobWorkerHandler(JobWorkerMetadata jobWorkerMetadata, JobWorkerInvoker invoker,
            ...
            JobWorkerExceptionHandler exceptionHandler, ClientRuntimeConfig.AutoCompleteConfig autoCompleteConfig,
            ...
            invoker.invoke(client, job)
                    ...
                    .exceptionally(ex -> {
                        ...
                        try {
                            ...
                            tracingContext.error(Tracing.JOB_EXCEPTION, ex);
                            ...
                            if (ex instanceof BpmnError) {
                                ...
                                JobWorkerCommand.createThrowErrorCommand(client, job, (BpmnError) ex)
                                        .request(tracingContext, metricsRecorder, backoffSupplier, exceptionHandler,
                                                autoCompleteConfig.maxRetries(), autoCompleteConfig.retryDelay())
                                        .send();
                                return null;
