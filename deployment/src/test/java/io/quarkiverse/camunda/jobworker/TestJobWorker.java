package io.quarkiverse.camunda.jobworker;
...
public class TestJobWorker {
    ...
    public void testThrow2(@VariablesAsType Parameter p) throws BpmnError {
        Log.infof("job 'test.throw2' parameter: %s", p);
        p.info = "test.throw";
        throw new BpmnError("throw custom error code", "throw custom error message");
    }
