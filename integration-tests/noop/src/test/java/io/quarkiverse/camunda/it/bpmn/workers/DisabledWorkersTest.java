package io.quarkiverse.camunda.it.bpmn.workers;
...
import io.quarkiverse.camunda.it.bpmn.sayhello.SayHelloParameter;
...
public class DisabledWorkersTest extends AbstractTest {
    ...
    public static class DisabledWorkersProfile implements QuarkusTestProfile {
        ...
        public Map<String, String> getConfigOverrides() {
            return Collections.singletonMap("quarkus.camunda.client.workers.disabled", "true");
        }
