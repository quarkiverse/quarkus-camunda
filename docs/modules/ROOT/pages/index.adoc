...
This extension is setting up the Camunda Client and Camunda Process Test Context for the test environment.

To use the `CamundaClient` and `CamundaAssert` in the tests use the `@QuarkusTestResource(CamundaTestResource.class)`.
If you want to use `CamundaProcessTestContext` you need to annotate it with `@InjectCamundaTestContext`:
...
public class BaseTest {
    ...
    @InjectCamundTestContext
    CamundaProcessTestContext testContext;
    ...
    public void startProcessTest() {
        ...
        testContext.increaseTime(Duration.ofHours(1L));
...
----
For more information check examples in the `integration-tests` directory in this repo and the https://docs.camunda.io/docs/apis-tools/testing/getting-started[official documentation] by Camunda.
